          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="flex flex-col md:flex-row flex-1 min-h-0 overflow-hidden">
                {/* Profile Sidebar */}
                <div className="w-full md:w-80 bg-slate-50 border-r border-slate-100 p-8 flex flex-col items-center text-center overflow-y-auto">
